...
const WhatsAppButton = () => {
  const phoneNumber = '+250795177094';
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <div className="absolute bottom-full right-0 mb-2 bg-gray-800 text-white text-sm rounded-lg px-3 py-1 whitespace-nowrap opacity-0 hover:opacity-100 transition-opacity duration-300 pointer-events-none">
