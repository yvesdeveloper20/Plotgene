      ...
      <div className="md:flex md:items-center md:justify-between">
        ...
        <div className="mt-4 flex md:mt-0 md:ml-4">
          <Link
            ...
            className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-900 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gold-500"
          >
            Add Product
          </Link>
        </div>
              ...
              {filteredProducts.map((product) => (
                <tr key={product.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <a href="#" className="text-gold-600 hover:text-gold-900 mr-3">Edit</a>
                    <button
